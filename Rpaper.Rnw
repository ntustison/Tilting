...
\subsubsection{\added[id=hj]{Rigourously }Define the Algorithm's Context}
...
\subsubsection{\replaced[id=hj]{Demand that the algorithm developers provide default parameters for the context being investigated}{Hassle the developers for a set of default parameters}}
...
is due to the algorithm itself\replaced[id=tr]{,}{or} the implementation\added[id=tr]{, or the parameter tuning}.
